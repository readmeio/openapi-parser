...
// TODO: clear out this garbage potentially?
 ...
 */
exports.openapiV1 = require('./v1.2/apiDeclaration.json');
/**
 * JSON Schema for OpenAPI Specification v2.0
 */
exports.openapiV2 = require('./v2.0/schema.json');
/**
 * JSON Schema for OpenAPI Specification v3.0
 */
exports.openapiV3 = require('./v3.0/schema.json');
/**
 * JSON Schema for OpenAPI Specification v3.1
 */
exports.openapiV31 = require('./v3.1/schema.json');
/**
