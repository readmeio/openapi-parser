...
describe('Better errors', function () {
  ...
  describe('misplaced `additionalProperty`', function () {
    it('Swagger 2.0', assertInvalid('2.0/misplaced-additionalProperty.yaml', 'originalRef is not expected to be here'));

    it('OpenAPI 3.0', assertInvalid('3.0/misplaced-additionalProperty.yaml', 'originalRef is not expected to be here'));
  });
