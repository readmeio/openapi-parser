...
describe('Invalid APIs (specification validation)', function () {
  it('should bypass validation if "options.validate.spec" is false', async function () {
  ...
  describe('Swagger 2.0-specific cases', function () {
    it(
      'should catch invalid response codes',
      assertInvalid(
    ...
    it(
      'should catch multiple body parameters in path',
      assertInvalid(
    ...
    it(
      'should catch multiple body parameters in operation',
      assertInvalid(
    ...
    it(
      'should catch multiple body parameters in path & operation',
      assertInvalid(
    ...
    it(
      'should catch if there are body and formData parameters',
      assertInvalid(
    ...
    it(
      'should catch duplicate path placeholders',
      assertInvalid(
    ...
    it(
      'should catch `file` parameters without a `consumes` declaration',
      assertInvalid(
    ...
    it(
      'should catch `file` parameters with an invalid `consumes` declaration',
      assertInvalid(
    ...
    it(
      "should catch if a required property in a component doesn't exist",
      assertInvalid(
    ...
    it(
      'should allow a `file` parameter with a vendor specific form-data `consumes` declaration',
      assertValid('2.0/file-vendor-specific-consumes-formdata.yaml')
    );

    it(
      'should allow a `file` parameter with a vendor specific urlencoded `consumes` declaration',
      assertValid('2.0/file-vendor-specific-consumes-urlencoded.yaml')
    );
  });

  describe('should catch duplicate header parameters', function () {
    it(
      'Swagger 2.0',
      assertInvalid(
  ...
  describe('should catch duplicate operation parameters', function () {
    it(
      'Swagger 2.0',
      assertInvalid(
  ...
  describe('should catch path parameters with no placeholder', function () {
    it(
      'Swagger 2.0',
      assertInvalid(
  ...
  describe('should catch path placeholders with no corresponding parameter', function () {
    it(
      'Swagger 2.0',
      assertInvalid(
  ...
  describe('should catch if no path parameters are present, but placeholders are', function () {
    it(
      'Swagger 2.0',
      assertInvalid(
  ...
  describe('should catch array parameters without a sibling `items`', function () {
    it(
      'Swagger 2.0',
      assertInvalid(
  ...
  describe('should catch array body parameters without a sibling `items`', function () {
    it(
      'Swagger 2.0',
      assertInvalid(
  ...
  describe('should catch array response headers without a sibling `items', function () {
    it(
      'Swagger 2.0',
      assertInvalid(
    ...
    describe('should also catch the same within `content`', function () {
      it(
        'OpenAPI 3.x',
        assertInvalid(
  ...
  describe("should catch if a required property in an input doesn't exist", function () {
    it(
      'Swagger 2.0',
      assertInvalid(
  ...
  describe('should allow schema-declared required properties to be inherited by an `allOf`', function () {
    it('Swagger 2.0', assertValid('2.0/inherited-required-properties.yaml'));

    // @todo add a case for this
    it.skip('OpenAPI 3.x', assertValid('3.x/inherited-required-properties.yaml'));
  });

  describe('should catch duplicate operation IDs', function () {
    it(
      'Swagger 2.0',
      assertInvalid('2.0/duplicate-operation-ids.yaml', "Validation failed. Duplicate operation id 'users'")
    );

    it(
      'OpenAPI 3.x',
      assertInvalid('3.x/duplicate-operation-ids.yaml', "Validation failed. Duplicate operation id 'users'")
    );
  });

  describe('should catch array response bodies without a sibling `items`', function () {
    it(
      'Swagger 2.0',
      assertInvalid(
  ...
  describe('should catch invalid discriminators', function () {
    ...
    it('OpenAPI 3.0', assertInvalid('3.0/invalid-discriminator.yaml', 'type must be object'));

    // @todo We can't yet write validation for this because our OpenAPI (and Swagger) spec
    // validators don't have the best, or fastest, handling for nested schemas. It would likely be
    // easier and faster to use something like `jsonpath` but that library unfortunately would add
    // a lot of bloat to this library and it doesn't play well with browsers.
    it.skip('OpenAPI 3.1', assertInvalid('3.1/invalid-discriminator.yaml', 'TKTK'));
  });

  describe('components / definitions', function () {
    describe('should allow a component schema name that contains hyphens', function () {
    ...
    describe('should catch a component schema name that contains a space', function () {
      it(
        'OpenAPI 3.0',
        assertInvalid(
      ...
      it(
        'OpenAPI 3.1',
        assertInvalid('3.1/component-schema-with-space.yaml', 'PROPERTY must match pattern "^[a-zA-Z0-9._-]+$')
      );
    });

    describe('should catch a component schema name that contains invalid characters', function () {
      it(
        'Swagger 2.0',
        assertInvalid(
      ...
      // Components with invalid characters is only **not** picked up with the 3.0 spec, so for 3.1
      // we can fallback to the normal schema validation -- which'll give us a different error
      // message.
      it(
        'OpenAPI 3.1',
        assertInvalid(
